    ...
    public void pollLdapForNewUsers() {
        ...
        for (LdapUser ldapUser : ldapUsers) {
            if (userRepository.findByEmail(ldapUser.getEmail()) == null) {
                ...
                String userDn = "uid=" + ldapUser.getEmail() + ",ou=users,ou=system"; // Adjust based on your LDAP structure
                String groupDn = "cn=" + ldapUser.getRole() + ",ou=roles,dc=example,dc=com"; // Adjust based on your LDAP structure
